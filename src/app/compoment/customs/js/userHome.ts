...
//        * Mobile nav toggle
//        */
//       const mobileNavShow: HTMLElement | null = document.querySelector('.mobile-nav-show');
//       const mobileNavHide: HTMLElement | null = document.querySelector('.mobile-nav-hide');
//
...
//        */
//       const navDropdowns: NodeListOf<HTMLElement> = document.querySelectorAll('.navbar .dropdown > a');
//
...
//
//             let dropDownIndicator: HTMLElement | null = this.querySelector('.dropdown-indicator');
